...
public class AT_卷纸 : BasicAliveThing
{
    public override void Act(int code)
    {

        //之后也许可以判断羁绊之类的
        GetComponent<Animator>().Play("AT_卷纸_Attack");
        AudioManager.Instance.PlaySoundEffectsByName("Sfx_Battle_Chequers_ScrollPaper_Attack");
        base.Act(code);
    }
